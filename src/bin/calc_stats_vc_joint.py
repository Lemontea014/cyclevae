...
def main():
    ...
    if args.feats_src_all is not None:
        #srcデータ1~81発話の統計計算
        scaler_feat_org_lf0_src_jnt = StandardScaler()
        ...
        for filename in filenames:
                ...
                scaler_feat_org_lf0_src_jnt.partial_fit(feat_org_lf0[:, :])

        filenames = read_txt(args.feats_src_all)
        print("number of source training utterances =", len(filenames))
        for filename in filenames:
                print(filename)
                feat_org_lf0 = read_hdf5(filename, "/feat_org_lf0")
        ...
        mean_feat_org_lf0_src_jnt = scaler_feat_org_lf0_src_jnt.mean_
        scale_feat_org_lf0_src_jnt = scaler_feat_org_lf0_src_jnt.scale_
        
        print(mean_feat_org_lf0_src_jnt)
        print(scale_feat_org_lf0_src_jnt)
        #trgデータ1~81発話の統計計算
        ...
        write_hdf5(args.stats, "/mean_feat_org_lf0_src_all_jnt", mean_feat_org_lf0_src_jnt)
        write_hdf5(args.stats, "/scale_feat_org_lf0_src_all_jnt", scale_feat_org_lf0_src_jnt)
        
        write_hdf5(args.stats, "/mean_feat_org_lf0_trg_all_jnt", mean_feat_org_lf0_trg_jnt)
        write_hdf5(args.stats, "/scale_feat_org_lf0_trg_all_jnt", scale_feat_org_lf0_trg_jnt)
